...
var SignUpGetFieldProps = ()=>{
    ...
    return (
        <div className="border border-2 border-success m-2 p-2 text-center bg-dark">
            <h1 className="text-white">Registration using GET FIELD PROPS</h1>
            <form onSubmit={myform.handleSubmit}>
                <label htmlFor="firstname" className="text-white">FirstName</label>&nbsp;&nbsp;
                <input className="border border-white rounded bg-dark text-white" type="text" {...myform.getFieldProps('firstname')} value={myform.values.firstname}/>
                ...
                <input className="border border-white rounded bg-dark text-white" type="text" {...myform.getFieldProps('lastname')} value={myform.values.lastname}/> 
                <h6 className="text-danger">{myform.touched.lastname && myform.errors.lastname}</h6>

                <label htmlFor="email" className="text-white">Email</label>&nbsp;&nbsp;
                <input className="border border-white rounded bg-dark text-white" type="email" {...myform.getFieldProps('email')} value={myform.values.email}/> 
                <h6 className="text-danger">{myform.touched.email &&myform.errors.email}</h6>
                

                <label htmlFor="password" className="text-white">Password</label>&nbsp;&nbsp;
                <input className="border border-white rounded bg-dark text-white" type="password" {...myform.getFieldProps('password')} value={myform.values.password}/> 
